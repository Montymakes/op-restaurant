...
export const createHiringPage = () => {
    ...
    jobs.innerHTML += `
                        <p>Now Hiring. Email your resume, 3 references, and a cover letter to <span class="bold">egkrabs@thekrustykrab.biz</span>. All salary inquires will be marked as spam and deleted.</p>
                        <ul>
                            <li>
                                <h2>Fry Cook (Full-time)</h2>
                                <p>span class="bold">Description: </span>Have you always wanted to make minimum wage working in a hot kitchen 6 days a week? Don't know how to cook? We don't care!</p>
                                <h3>Requirements:</h3>
                                <ul>
                            ...
                            <li>
                                ...
                                <p><span class="bold">Description: </span>Help The Krusty Krab expand it's a business portifolio. You will be a pioneer of pizza delivery.</p>
                                <h3>Requirements</h3>
